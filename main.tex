...
\begin{figure}[h]
    \centering
  \includegraphics[width=\textwidth]{capturas/Registrar auto.png}
    \caption{Registro de auto}
    \label{fig:miimagen}
\end{figure}
\clearpage
\begin{figure}[h]
    \centering
  \includegraphics[width=\textwidth]{capturas/Registrar moto.png}
    \caption{Registro de moto}
    \label{fig:miimagen}
\end{figure}
\clearpage
\begin{figure}[h]
    \centering
  \includegraphics[width=\textwidth]{capturas/Registrar camion.png}
    \caption{Registro de camion}
    \label{fig:miimagen}
\end{figure}
\clearpage
\begin{figure}[h]
    \centering
  \includegraphics[width=\textwidth]{capturas/Resumen de flotilla.png}
    \caption{Resumen de flotilla}
    \label{fig:miimagen}
\end{figure}
\clearpage
\begin{figure}[h]
    \centering
  \includegraphics[width=\textwidth]{capturas/Flotilla detallada.png}
    \caption{Detalle de flotila}
    \label{fig:miimagen}
\end{figure}
\clearpage
